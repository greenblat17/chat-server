...
//go:generate minimock -i github.com/greenblat17/chat-server/internal/repository.MessageRepository -o message_repository_minimock.go -n MessageRepositoryMock -p mocks
