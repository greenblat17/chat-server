...
//go:generate minimock -i github.com/greenblat17/chat-server/internal/repository.ChatRepository -o chat_repository_minimock.go -n ChatRepositoryMock -p mocks
